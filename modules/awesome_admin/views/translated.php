<?php
	...
	section_content(breadcrumb(['Awesome Admin' => site_url('awesome_admin'), 'Translate' => site_url('awesome_admin/translate'), 'Translated' => '']));
			...
			<div class="h5 pb-3 pb-md-4 mb-4 mb-md-5 mb-xl-4 border-bottom d-flex justify-content-between align-items-center">
				<div>
					<span class="fa-layers fa-fw fa-lg mr-2">
						...
						<span class="fa-layers-counter fa-layers-top-right bg-success shadow-sm mt-1"><i class="fas fa-check"></i></span>
					</span>
