<?php
	...
	section_content(breadcrumb([t('Manage News') => site_url('manage_news'), t('Edit Post') => '']));
	...
	<div class="container-fluid px-0" id="ar-app-form-article">
		...
		<div class="tab-content" id="myTabContent">
								...
								<div class="arv6-box bg-white rounded shadow-sm p-4">
									<div class="row">
										<div class="col-7 d-flex justify-content-end pe-0 mb-3">
											<a href="'.site_url('news/'.$row['uri']).'" class="btn btn-info font-size-inherit" target="_blank">Visit URL</a>
										</div>
									...
									$res_cat = $db->sql_select("select id, name from ml_news_category order by id desc");
			...
			<div class="tab-pane fade" id="seo-tab-pane" role="tabpanel" aria-labelledby="seo-tab" tabindex="0">
				<div class="ar-fetch-detail-metatag-article" id="ar-form-submit-seo" data-url="'.site_url('manage_news/getDetailMetatag/'.$row['id']).'">
					<form action="'.site_url('manage_news/setseo/'.$row['id'].'/from_edit_post').'" method="post" enctype="multipart/form-data" @submit="submitSEO" ref="formHTMLSEO" button-block="false" button-rounded-pill="false" font-size-large="false">
