<?php
	...
	section_content(breadcrumb([t('Manage News') => site_url('manage_news'), t('List of Category') => site_url('manage_news/category'), t('Edit Category') => '']));
	...
	<div class="container-fluid px-0" id="ar-app-listdata">
		<div class="arv6-box bg-white arv3-pc-content p-4 p-md-5 rounded shadow-sm" id="ar-form-submit">
			...
			<form action="'.site_url('manage_news/editcategory/'.$id).'" method="post" @submit="submit" button-block="false" font-size-large="false" button-rounded-pill="false" with-list-wopage="true" with-list-slideshow-page="false" with-list-coverimage-page="false" ref="formHTML">
				<div class="row">
