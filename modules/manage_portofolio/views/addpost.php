<?php
	...
	section_content(breadcrumb([t('Manage Portofolio') => site_url('manage_portofolio'), t('New Post') => '']));
	...
	<div class="container-fluid px-0 mb-5" id="ar-app-form-article">
		<div id="ar-form-submit">	
			<form action="'.site_url('manage_portofolio/addpost').'" method="post" enctype="multipart/form-data" @submit="submit" ref="formHTML" button-block="false" button-rounded-pill="false" font-size-large="false">
				<div class="row">
						...
						<div class="arv6-box bg-white rounded shadow-sm p-4">
							<div class="row">
								<div class="col-12 d-flex justify-content-end mb-3">
									...
									<input type="submit" class="btn btn-malika-submit font-size-inherit" value="'.t('Save & Publish').'">
								</div>	
				...
				section_content('
					...
					<div class="col-md-8">
						<div class="arv6-box bg-white rounded shadow-sm">
							<div class="p-4">
								<div class="h6 fw-bold pb-3 pb-md-4 mb-3 border-bottom"><i class="fad fa-plus fa-fw me-1"></i> New Post</div>
