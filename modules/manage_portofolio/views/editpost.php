	...
	<div class="container-fluid px-0" id="ar-app-form-article">
		...
		<div class="tab-content" id="myTabContent">
			<div class="tab-pane fade show active" id="main-tab-pane" role="tabpanel" aria-labelledby="main-tab" tabindex="0">
				<div class="ar-fetch-detail-article" id="ar-form-submit" data-url="'.site_url('manage_portofolio/getDetailPost/'.$row['id']).'">				
								...
								<div class="arv6-box bg-white rounded shadow-sm p-4">
									<div class="row">
										<div class="col-7 d-flex justify-content-end pe-0 mb-3">
											<a href="'.site_url('portofolio/'.$row['uri']).'" class="btn btn-info font-size-inherit" target="_blank">Visit URL</a>
										</div>
			...
			<div class="tab-pane fade" id="seo-tab-pane" role="tabpanel" aria-labelledby="seo-tab" tabindex="0">
				<div class="ar-fetch-detail-metatag-article" id="ar-form-submit-seo" data-url="'.site_url('manage_portofolio/getDetailMetatag/'.$row['id']).'">
					<form action="'.site_url('manage_portofolio/setseo/'.$row['id'].'/from_edit_post').'" method="post" enctype="multipart/form-data" @submit="submitSEO" ref="formHTMLSEO" button-block="false" button-rounded-pill="false" font-size-large="false">
			...
			<div class="tab-pane fade" id="custom-field-tab-pane" role="tabpanel" aria-labelledby="custom-field-tab" tabindex="2">
				<div class="ar-fetch-listdata-vars" id="ar-form-submit-custom-field" data-url="'.site_url('manage_portofolio/get_vars/'.$row['uri']).'">
					<form action="'.site_url('manage_portofolio/setcustomfield/'.$row['id']).'" method="post" enctype="multipart/form-data" @submit="submitCustomField" ref="formHTMLCustomField" button-block="false" button-rounded-pill="false" font-size-large="false">
															...
															<div class="col-md-6">
																<div class="row g-1 mb-2">
																	...
																	<div class="col-md-6 d-flex align-items-center justify-content-md-end">
																		<a href="javascript:void(0)" class="btn btn-link p-0 ar-alert-bootbox font-size-inherit" v-on:click="removeField(getDataVarText, index, \''.$row['id'].'\', \'text\')" v-bind:data-url="\''.site_url('manage_portofolio/deletefield/').'\'">'.t('Remove').'</a>
																	</div>
																</div>
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="row g-1 mb-2">
																	...
																	<div class="col-md-6 d-flex align-items-center justify-content-md-end">
																		<a href="javascript:void(0)" class="btn btn-link p-0 ar-alert-bootbox font-size-inherit" v-on:click="removeField(getDataVarText, index, \''.$row['id'].'\', \'image\')" v-bind:data-url="\''.site_url('manage_portofolio/deletefield/').'\'">'.t('Remove').'</a>
																	</div>
																</div>
