...
.preview2 img
{
	...
	<div class="container-fluid px-0">
		<div class="bg-white arv3-pc-content p-3 p-md-4 rounded shadow-sm" id="ar-app-listdata">
			<div class="h5 pb-3 pb-md-4 mb-3 border-bottom d-flex justify-content-between align-items-center"><div><i class="fad fa-folder-open fa-fw me-2"></i> '.t('Manage Portofolio').'</div> <div><span class="float-md-right font-size-normal"><a href="'.site_url('manage_portofolio/addpost').'">Add New Post</a></div></div>
			
			<div class="row mb-2 ar-fetch-listdata" id="ar-data" data-url="'.site_url('manage_portofolio/getListPosts').'">
				<div class="col-md-4 mb-3 mb-md-0">
					<div class="form-group">
						<label class="form-label">Search Portofolio by Title</label>
				...
				<div class="col-md-4">
					...
					$res = $db->sql_select("select id, name from ml_portofolio_category order by id desc");
