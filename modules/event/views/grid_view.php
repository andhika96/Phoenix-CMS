<?php
	...
	<div class="container py-3 py-md-5" id="ar-app-listdata-article">
		<div class="ar-fetch-listdata" id="ar-data" data-url="'.site_url('event/getListPosts').'">
			<div class="pb-5">
				<div class="row">
					<div class="col-md-4 mb-3 mb-md-0">
						<div class="h2 fw-bold">Our Event</div> <p>find the latest event from us '.get_layout('event', 'is_hide_category').'</p>
					</div>';
