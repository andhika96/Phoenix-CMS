<?php
	...
	<div class="container py-3 py-md-5" id="ar-app-listdata-article">
		<div class="pb-3 pb-md-5">
			<div class="h2 fw-bold">Our Event</div> <p>find the latest event from us</p>
		</div>

		<!-- List View -->
		<div class="row ph-list-view ar-fetch-listdata" id="ar-data" data-url="'.site_url('event/getListPosts').'">
