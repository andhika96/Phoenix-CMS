	...
	<div class="container-fluid">
		<div class="bg-white arv3-pc-content p-3 p-md-4 rounded shadow-sm">
			<div class="h5 pb-3 pb-md-3 mb-4 border-bottom d-flex justify-content-between align-items-center">
				<div>
					<i class="fas fa-columns fa-fw mr-2"></i> Manage Pages 
					<div class="mt-3 font-size-normal font-weight-normal"><i class="fas fa-info-circle fa-fw mr-1 text-info"></i> Halaman ini berfungsi untuk mengganti bagian-bagian (section) pada halaman depan, seperti mengganti foto sampul, judul, beserta keterangannya.</div>
				</div>
			</div>

			<ul class="list-group list-group-flush ar-list-group-flush">');
	
	$res = $db->sql_select("select * from ml_pages order by id desc");
				...
				<li class="list-group-item list-group-item-action px-0">
					<div class="row no-gutters">
						...
						<div class="col-12 col-sm-8 text-left">
							<h5 class="lh-6 text-truncate"><a href="'.site_url('manage/editpage/'.$row['uri']).'" class="text-decoration-none">'.$row['name'].'</a></h5>
