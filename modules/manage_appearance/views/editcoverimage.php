	...
	<div class="container-fluid px-0 mb-5">
		<div class="bg-white arv3-pc-content p-3 p-md-4 rounded shadow-sm" id="ar-app-listdata">
			...
			<div id="ar-form-submit">
				<form action="'.site_url('manage_appearance/editcoverimage/'.$uri).'" method="post" @submit="submit" button-block="false" font-size-large="false" button-rounded-pill="false" with-list-wopage="false" with-list-slideshow-page="false" with-list-coverimage-page="true" ref="formHTML">
							...
							<div class="col-12 mb-4" v-for="(info, index) in getListFormCoverimage" :key="index">
								<div class="row mb-3">
									...
									<div class="col-md-6 text-md-end">
										<a href="javascript:void(0)" v-on:click="deleteForm(getListFormCoverimage, index, info.id); showData = !showData" class="text-danger text-underline ar-alert-bootbox font-size-inherit" v-bind:data-url="\''.site_url('manage_appearance/deletecoverimage/').'\'">Delete Image</a>
									</div>
								</div>
