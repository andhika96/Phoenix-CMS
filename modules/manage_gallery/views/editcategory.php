<?php
	...
	section_content(breadcrumb([t('Manage Gallery') => site_url('manage_gallery'), t('Edit Category') => '']));
	...
	<div class="container-fluid px-0" id="ar-app-listdata">
		<div class="arv6-box bg-white arv3-pc-content p-4 p-md-5 rounded shadow-sm" id="ar-form-submit">
			...
			<form action="'.site_url('manage_gallery/editcategory/'.$id).'" method="post" @submit="submit" button-block="false" font-size-large="false" button-rounded-pill="false" with-list-wopage="true" ref="formHTML">
				<div class="row">
