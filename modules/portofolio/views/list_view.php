<?php
	...
	<div class="container py-3 py-md-5" id="ar-app-listdata-article">
		<div class="pb-3 pb-md-5">
			<div class="h2 fw-bold">Our Event</div> <p>find the latest portofolio from us</p>
		</div>

		<!-- List View -->
		<div class="row ph-list-view ar-fetch-listdata" id="ar-data" data-url="'.site_url('portofolio/getListPosts').'">
							...
							<div class="ph-event d-block d-md-inline-flex w-100 mb-4" v-for="(info, index) in getData" v-bind:key="info.id">
								...
								<div class="details">
									<div class="wrapper">
										...
										<a :href="\''.site_url('event/\'+info.uri+\'').'\'" class="more_listing text-mg-red">Read More</a>
									</div>
								</div>
			...
			<div class="col-lg-4 col-xl-3">
				<div class="border border-radius-10 p-4 mb-4">
					...
					<div class="input-group ph-search-container mb-3">
						<input type="text" class="form-control font-size-inherit" placeholder="Search by title" aria-label="Search by title" aria-describedby="search-event" v-model="getSearch" @keyup="searchData">
						<span class="input-group-text" id="search-event"><i class="fas fa-search font-size-inherit"></i></span>
					</div>
				</div>';
				...
				<div class="border border-radius-10 p-4">
					...
					foreach ($category as $key => $value) 
					{
						...
						<li class="list-group-item">
							<a href="javascript:void(0)" @click.prevent="clickCategory('.$value['id'].')">
								'.$value['name'].'
							</a>
						</li>';
					}
