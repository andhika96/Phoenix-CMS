	...
	<div class="container-fluid px-0" id="ar-app-form-article">
		<ul class="nav nav-tabs mb-3" id="pills-tab" role="tablist">
			<li class="nav-item" role="presentation">
				<button class="nav-link active" id="main-tab" data-bs-toggle="tab" data-bs-target="#main-tab-pane" type="button" role="tab" aria-controls="main-tab" aria-selected="true">Main</button>
			</li>

			<li class="nav-item" role="presentation">
				<button class="nav-link" id="seo-tab" data-bs-toggle="tab" data-bs-target="#seo-tab-pane" type="button" role="tab" aria-controls="seo-tab" aria-selected="false">SEO</button>
			</li>
		...
		<div class="tab-content" id="myTabContent">
			...
			<div class="tab-pane fade" id="seo-tab-pane" role="tabpanel" aria-labelledby="seo-tab" tabindex="1">
			...
			<div class="tab-pane fade" id="custom-field-tab-pane" role="tabpanel" aria-labelledby="custom-field-tab" tabindex="2">
				<div class="ar-fetch-listdata-vars" id="ar-form-submit-custom-field" data-url="'.site_url('manage_promotion/get_vars/'.$row['uri']).'">
					<form action="'.site_url('manage_promotion/setcustomfield/'.$row['id']).'" method="post" enctype="multipart/form-data" @submit="submitCustomField" ref="formHTMLCustomField" button-block="false" button-rounded-pill="false" font-size-large="false">
															...
															<div class="col-md-6">
																<div class="row g-1 mb-2">
																	...
																	<div class="col-md-6 d-flex align-items-center justify-content-md-end">
																		<a href="javascript:void(0)" class="btn btn-link p-0 ar-alert-bootbox font-size-inherit" v-on:click="removeField(getDataVarText, index, \''.$row['id'].'\', \'text\')" v-bind:data-url="\''.site_url('manage_promotion/deletefield/').'\'">'.t('Remove').'</a>
																	</div>
																</div>
														...
														<div class="row">
															...
															<div class="col-md-6">
																<div class="row g-1 mb-2">
																	...
																	<div class="col-md-6 d-flex align-items-center justify-content-md-end">
																		<a href="javascript:void(0)" class="btn btn-link p-0 ar-alert-bootbox font-size-inherit" v-on:click="removeField(getDataVarText, index, \''.$row['id'].'\', \'image\')" v-bind:data-url="\''.site_url('manage_promotion/deletefield/').'\'">'.t('Remove').'</a>
																	</div>
																</div>
