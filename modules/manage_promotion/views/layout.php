<?php
	...
	section_content(breadcrumb([t('Manage Promotion') => site_url('manage_promotion'), t('Layout Settings') => '']));
	...
	<div class="container-fluid px-0 mb-5">
		<div class="bg-white arv3-pc-content p-3 p-md-4 rounded shadow-sm" id="ar-app-listdata">
			...
			<div id="ar-form-submit">
				<form action="'.site_url('manage_promotion/layout').'" method="post" @submit="submit" button-block="false" font-size-large="false" button-rounded-pill="false" with-list-wopage="false" with-list-slideshow-page="false" with-list-coverimage-page="false" ref="formHTML">
